...
\newcommand{\titleBackground}{
	...
	\fill[fill=mainColor] (current page.south west) rectangle ++(7.8cm, \paperheight);
	\end{tikzpicture}
}
...
\setlength{\myHorizontalTotalMargins}{6mm} %6mm if paper is a4 + 3mm on each border, 0mm if true a4
