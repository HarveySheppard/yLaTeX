...
This package also implement an environment that typeset code listings: \\\verb|\codeInfo{<Title>}[<caption>][<language>]{<Code>}|. The caption and the language arguments are optionnal. \verb|<language>| is the language in which the listed code is written, as given in the list of supèported language in the listings package documentation.

Which results in this:

\codeInfo{Title}[This is a caption]{var a = "Hello world"
while true:
print(a)
}

For the moment, code indentation is not supported but I will find a solution to this little bug!
